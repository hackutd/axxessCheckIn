            ...
            emails.map(async (email) => {
                try {
                    ...
                    const msg: sendgrid.MailDataRequired = {
                        ...
                        text: `Hello,\n\nThank you for registering for the Axxess Hackathon. Below is your unique QR code for check-in and food! Check-in is from 9 am to 11 am. We recommend arriving between 9 and 10 am to get in line for check-in. Walk-ins begin at 10 am so we cannot guarantee you a spot even if you have a QR code after 10 am. \n\nLocation:\nECSW 1.100 Axxess Atrium\n800 W. Campbell Road, Richardson, Texas 75080\n\nParking passes can be found here:\nhttps://tinyurl.com/axxess-park\n\nPrint them out and put them on your dashboard. Please also join the Discord to stay up to date with the event:\nhttps://tinyurl.com/axxess-discord\n\nIf you have any questions, please reach out to axxess@acmutd.co.\n\nBest regards,\n\nThe Axxess Hackathon Team`,
                        attachments: [
                            {
                                content: qrcode,
                                filename: "qrcode.png",
